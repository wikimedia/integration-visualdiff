...
var computeOpts = function(argv, opts) {
	...
	var fileName = opts.filePrefix.replace(/[^0-9A-Za-z#%,_\-\.\x80-\uD7FF\uE000-\uFFF]+/g, function(c) { return encodeURI(c); });
	if (fileName.length > 180) {
		fileName = fileName.substring(0, 150) + "." + makeHash(fileName);
	}
	var filePath = opts.outdir + fileName;
