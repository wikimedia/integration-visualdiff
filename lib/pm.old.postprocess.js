...
// edit form, chrome, and extract the old (left) view out
...
window.postprocessDOM = function() {
	try {
		...
		// Extract the old (left) display out of the table and delete the table
		$('td.mw-parsermigration-left').children().each(function() {
